...
<section>
  ...
  <p className="text-center">
    Nos <strong>exemples de CV vierges</strong> vous permettront d’indiquer tout ce qui est nécessaire pour réaliser le vôtre. Comme expliqué dans les fonctionnalités de notre éditeur, vous pourrez structurer votre CV en 5 parties. Voici en détail comment bien rédiger votre Curriculum Vitae après avoir choisi votre exemple.
  </p>
  <h3 className="number-listing pb-3 pt-3">
    <span className="number-listing pb-3">1- </span> Votre profil
  </h3>
  <p>
    Dans cette rubrique du CV, vous devrez indiquer votre nom, prénom, métier recherché, coordonnées, date de naissance. Il est aussi possible d’indiquer si vous êtes titulaire d’un permis de conduire. Nous vous invitons aussi à ajouter une photo de vous, mais ce n’est pas obligatoire.
  </p>
  <p>
    Découvrez nos <a href="#">conseils et exemples de rédaction de la section « profil » du CV</a>.
  </p>
  <h3 className="number-listing pb-3 pt-3">
    <span className="number-listing pb-6">2- </span> À propos de vous
  </h3>
  <p>
    Certains de <strong>nos modèles CV présentent une section « À propos de vous »</strong>. Vous devrez donc indiquer en quelques lignes votre profil ainsi que vos objectifs et vos motivations. Ce résumé sera lu en premier par l’employeur. Soignez-le. Soyez convaincant et <strong>donnez envie au recruteur de lire la suite de votre CV</strong>.
  </p>
  <h3 className="number-listing pb-3 pt-3">
  ...
  <ul>
    ...
    <li>les compétences acquises dans l’entreprise.</li>
  </ul>
  <p>
    Pour plus d’informations, nous avons créé un <a href="https://modele-cv.com/conseils-cv/experiences-professionnelles-cv/">guide complet pour vous aider dans la rédaction de vos expériences professionnelles sur votre CV</a>.
  </p>
  <h3 className="number-listing pb-3 pt-3">
    <span className="number-listing">4- </span> Vos formations et diplômes
  </h3>
  <p>
  ...
  <p>
    Découvrez plus en détail <a href="https://modele-cv.com/conseils-cv/formations-cv/">toutes les astuces pour intégrer vos formations dans votre Curriculum Vitae</a>.
  </p>
  <h3 className="number-listing pb-3 pt-3">
    <span className="number-listing">5- </span> Vos compétences acquises
  </h3>
  <p>
    Cette partie du CV est décisive. Vous allez devoir <strong>détailler les compétences que vous avez acquises durant vos expériences professionnelles et vos formations</strong>. Veillez à rester pertinent dans vos choix. Accordez-vous avec les compétences recherchées dans le poste convoité.
  </p>
  <p>
    Découvrez la <a href="https://modele-cv.com/conseils-cv/competences-cv/">liste des compétences à intégrer dans votre CV</a>.
  </p>
  <h3 className="number-listing pb-3 pt-3">
    <span className="number-listing">6- </span> Vos loisirs ou centres d’intérêts
  </h3>
  <p>
  ...
  <p>
    N’oubliez pas de structurer ces différentes parties de manière chronologique (du plus récent au plus ancien) afin de mettre en avant vos dernières expériences. Pour plus de détails pour rédiger cette rubrique, lisez notre <a href="https://modele-cv.com/conseils-cv/rediger-centres-dinterets/">guide complet ici</a>.
  </p>
  <h2 id="notre-liste-de-modele-de-cv-gratuit-a-telecharger">Notre liste de modèle de CV gratuit à télécharger</h2>
  <p>
    Pour ceux qui ne souhaitent pas utiliser notre éditeur en ligne, vous pouvez <strong>télécharger ici un exemple de CV gratuitement</strong>. Voici les étapes à suivre pour <a href="/creer-cv/">créer votre CV gratuitement</a> sans aucun frais.
  </p>
</section>
